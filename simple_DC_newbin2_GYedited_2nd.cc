...
// CCC : binning needs to be changed here - the largest bin is 61(NEOS) so, isn't it 100 is enough?	   
   ...
   //}
   tempVec[0] = new TH1D("","",newBin_DCDYB,0,10);
...
//newBin
/*
fHist = new TH2D("","",newBin_DCDYB,binEdge,newBin_DCDYB,binEdge);
fHist_DC = new TH2D("","",newBin_DCDYB,binEdge,newBin_DCDYB,binEdge);
fHist_DYB = new TH2D("","",newBin_DCDYB,binEdge,newBin_DCDYB,binEdge);
fHist_RENO = new TH2D("","",newBin_RENO,binEdge,newBin_RENO,binEdge);
fHist_NEOS = new TH2D("","",newBin_NEOS,binEdge,newBin_NEOS,binEdge);
fHist_PROS = new TH2D("","",newBin_PROS,binEdge,newBin_PROS,binEdge);
*/
