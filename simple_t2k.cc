...
/*
void Sterile:: preparePrediction(RooListProxy* _pulls, std::vector<TGraph*> predList){ 

  TGraph* meuller238 = new TGraph("data/mueller235.txt", "%lg %*lg %*lg %*lg %lg", "");
  TGraph* meuller235 = new TGraph("data/mueller238.txt", "%lg %*lg %lg %*lg %*lg %*lg %*lg %*lg", "");
  ...
  preList.push_back(meuller238);
  preList.push_back(meuller235);
  preList.push_back(meuller239);
  preList.push_back(meuller241);


}

void Sterile:: prepareData(RooListProxy* _pulls, std::vector<TGraph*> dataList){

  TGraph* dataDC   = new TGraph("data/dataDC.txt", "%*lg %lg %lg", "");
  TGraph* dataDYB  = new TGraph("data/dataDYB.txt", "%*lg %lg %lg", "");
  TGraph* dataRENO = new TGraph("data/dataRENO.txt", "%*lg %lg %lg", "");
  TGraph* dataNEOS = new TGraph("data/dataNEOS.txt", "%*lg %lg %lg", "")
...
//rep->preparePrediction(rep->getPullList, inputSpectra);
//rep->prepareData();
